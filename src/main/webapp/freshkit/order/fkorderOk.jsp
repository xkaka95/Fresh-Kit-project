            ...
            <div id="content" class="payorder_wrap">
                ...
                <div class="order_fix">
                    ...
                    <div class="order_desc_bot">
                        <a href="../mypage/orderList.jsp"><button type="button" class="btn btn-outline-dark btn-lg">주문내역보러가기</button></a>
                        <a href="../main/main.jsp"><button type="button" class="btn btn-success btn-lg">메인 페이지로 가기 </button></a>
                    </div>
